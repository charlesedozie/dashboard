            ...
            <tbody>
              {currentStudents.map((student) => (
                ...
                <td className="py-2 border-b border-gray-200 align-middle">
				   ...
				   <td className="py-2 border-b text-left border-gray-200 align-middle">
                    {student.gender}
                  </td>
                  <td className="py-2 border-b text-center border-gray-200 align-middle">
                    {student.lessons}
                  </td>
				   <td className="text-center py-2 border-b border-gray-200 align-middle">
                  <button className="bg-transparent border-0 border-b border-gray-400 text-gray-700 px-3 text-xs py-2 pointer hover:border-gray-600 focus:outline-none">
 View Info
</button>
</td>
