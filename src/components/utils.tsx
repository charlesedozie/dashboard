...
router.push(`/user-area/dboard?action=search&mod=search&section=${section}&q=${encodeURIComponent(data.query)}`);
};
...
return (
<div className="p-4">{section ? section : 'no section'} end section {encodeURIComponent(query) ? encodeURIComponent(query) : 'no q irem'}
