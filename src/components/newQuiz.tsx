...
console.log('dataCurQuestions', dataCurQuestions)
...
return (
<div className="p-4">
<SubTitle string1={itemId ? 'Update Quiz' : 'New Quiz'} />
<div className="mt-8">
<div
role="tablist"
...
{shouldShowQuestions && (
<div className="bg-white w-full p-3 mb-6">
...
<th className="py-2 text-left text-sm border-b border-gray-200">Question</th>
<th className="py-2 text-left text-sm border-b border-gray-200">Answer</th>
