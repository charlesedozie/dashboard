...
<div className="flex gap-4"><FolderPen className={`${isDark ? "text-white" : "def-color"}`}  size={30} />
<div><p className="block font-medium mb-1">Name</p>
<p className="block font-medium text-gray-800 mb-1">
<span className={`${isDark ? "block text-xs text-gray-300" : "block text-xs text-gray-500"} transition-colors duration-300`}>Your fullname that is displayed to the students.
</span></p></div></div></div>
...
<section className="mt-7 flex items-center gap-4 mb-3">
{/* Left: Icon + Label + Description + Current Email */}
<div className="flex-1 flex flex-col gap-1">
<div className="flex gap-4"><Mail className={`${isDark ? "text-white" : "def-color"}`} size={30} />
<div><p className="block font-medium mb-1">Email Address</p>
<p className="block font-medium mb-1">
<span className={`${isDark ? "block text-xs" : "block text-xs text-gray-500"} transition-colors duration-300`}>
...
{/* Left: Icon + Label + Description + Current Email */}
<div className="flex-1 flex flex-col gap-1">
<div className="flex gap-4"><Phone className={`${isDark ? "text-white" : "def-color"}`} size={30} />
