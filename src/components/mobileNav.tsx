...
const navItems = [
  { href: '/user-area/dboard', label: 'Home', icon: Home },
  { href: '/user-area/dboard?action=list', label: 'Lessons', icon: BookOpen },
  { href: '/user-area/profile', label: 'Profile', icon: User },
  { href: '/user-area/setting', label: 'Settings', icon: Settings }
];
...
/>
        ...
        <button onClick={() => setIsOpen(!isOpen)} className="p-2 pointer rounded-md hover:bg-gray-100">
