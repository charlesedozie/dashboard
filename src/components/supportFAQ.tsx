...
<button
className="flex-1 flex justify-between items-center px-4 py-3 text-left font-medium hover:bg-gray-50 transition"
...
{/* Answer */}
{openIndex === index && (
<div className="px-4 py-3 text-gray-700 mb-5">{faq.answer}</div>
)}
</div>
))) : ( null )}
</div>
