...
<div className="">
<section>
<div className="flex justify-between items-center p-4 bg-gray-100 rounded-md md:hidden">
{/* Left Element */}
...
<div className="w-full md:w-[250px] flex flex-col flex-shrink-0 justify-between p-4 bg-white h-full">
<SideBar /> 
